...
# Generated by scripts/adapters/cursor.sh. Do not edit manually.
...
# Awakening: load PRISTINO.md → Constitution $CONSTITUTION → PRISTINO-INDEX.md → diagnose first-use → diagnose user-context → greet

# Runtime Context Contract
$(acl_runtime_context_contract | sed 's/^/# /')

# Input Tolerance
$(acl_input_tolerance | sed 's/^/# /')
...
# Tool Access (MCP)
$(acl_tool_access_contract | sed 's/^/# /')
# - Cursor wiring: add workspace-mcp under mcpServers in .cursor/mcp.json. Template: references/mcp/cursor.mcp.json.example.
...
# Generated by scripts/adapters/cursor.sh. Do not edit manually.
# Environment: windsurf | Triad: checklist | Tools: Read/Write/Edit/Bash | MCP: yes via ~/.codeium/windsurf/mcp_config.json | Multimodal: limited
# Components: $SKILLS_COUNT skills · $AGENTS_COUNT agents · $COMMANDS_COUNT commands
...
# Tool Access (MCP)
$(acl_tool_access_contract | sed 's/^/# /')
# - Windsurf wiring: add workspace-mcp under mcpServers in ~/.codeium/windsurf/mcp_config.json (Cascade > MCP > Manage). Template: references/mcp/windsurf.mcp_config.json.example.
...
# Requires: Windsurf IDE. Not supported: Agent tool, hooks, workspace management.
WINDRULES
