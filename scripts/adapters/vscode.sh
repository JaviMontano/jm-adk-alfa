...
# JM-ADK v$VERSION — Visual Studio / Copilot Instructions
...
Load: PRISTINO.md → Constitution $CONSTITUTION → PRISTINO-INDEX.md → diagnose first-use → diagnose user-context
