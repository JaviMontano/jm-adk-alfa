# JM-ADK v5.2.0 — GEMINI Runtime Instructions
...
Components: 602 skills · 261 agents · 267 commands · 256 prompts

## Awakening

Load: PRISTINO.md → Constitution v6.0.0 → PRISTINO-INDEX.md → diagnose first-use → diagnose user-context → greet.
