...
SKILL_DIR="$ROOT/skills/health-check-automation"
VALIDATOR="$SKILL_DIR/scripts/validate_health_check.py"
TMP_OUTPUT="$(mktemp)"
...
printf 'health-check-automation check passed: valid=%s invalid=%s\n' "$valid_count" "$invalid_count"
