...
version: 0.1.0
description: "Redacta agradecimientos diferenciados por persona en voz de marca y los linta contra trademarks apiladas/FOMO/hustle."
owner: "JM Labs"
triggers:
...
`scripts/lint_gratitud.py --input <txt>` flags stacked trademarks (>1), FOMO, hustle glorification, and servility. Exit 1 on violations. Deterministic checks: `scripts/check.sh` + fixtures.
