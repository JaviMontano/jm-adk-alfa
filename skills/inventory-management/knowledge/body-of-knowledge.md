...
generated-for: inventory-management
generated-on: 2026-05-28
overwrite-policy: missing-only unless --force
-->

# Inventory Management Body of Knowledge

## Canon

Use this file for stable domain knowledge, standards, and reusable heuristics for `inventory-management`.
