...
generated-for: station-create
generated-on: 2026-06-05
overwrite-policy: missing-only unless --force
-->

# Station Create Body of Knowledge

## Canon

Use this file for stable domain knowledge, standards, and reusable heuristics for `station-create`.
