...
SKILL_DIR="$ROOT/skills/pristino-calibration"
VALIDATOR="$SKILL_DIR/scripts/validate_pristino_calibration.py"
...
validator_path = skill_dir / "scripts" / "validate_pristino_calibration.py"
spec = importlib.util.spec_from_file_location("pristino_validator", validator_path)
...
printf 'pristino-calibration check passed: valid=%s invalid=%s\n' "$valid_count" "$invalid_count"
