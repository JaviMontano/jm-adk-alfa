...
SKILL_DIR="$ROOT/skills/quality-metrics"
VALIDATOR="$SKILL_DIR/scripts/validate_quality_metrics.py"
...
validator_path = skill_dir / "scripts" / "validate_quality_metrics.py"
spec = importlib.util.spec_from_file_location("quality_metrics_validator", validator_path)
...
printf 'quality-metrics check passed: valid=%s invalid=%s\n' "$valid_count" "$invalid_count"
