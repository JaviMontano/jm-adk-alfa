...
SKILL_DIR="$ROOT/skills/katas-validation-retry-feedback"
VALIDATOR="$SKILL_DIR/scripts/validate_validation_retry_feedback.py"
...
validator_path = skill_dir / "scripts" / "validate_validation_retry_feedback.py"
spec = importlib.util.spec_from_file_location("validation_retry_validator", validator_path)
...
printf 'katas-validation-retry-feedback check passed: valid=%s invalid=%s\n' "$valid_count" "$invalid_count"
