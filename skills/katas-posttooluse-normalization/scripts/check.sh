...
SKILL_DIR="$ROOT/skills/katas-posttooluse-normalization"
VALIDATOR="$SKILL_DIR/scripts/validate_posttooluse_normalization.py"
...
validator_path = skill_dir / "scripts" / "validate_posttooluse_normalization.py"
spec = importlib.util.spec_from_file_location("posttooluse_validator", validator_path)
...
printf 'katas-posttooluse-normalization check passed: valid=%s invalid=%s\n' "$valid_count" "$invalid_count"
