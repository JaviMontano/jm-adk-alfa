...
SKILL_DIR="$ROOT/skills/pdf-architecture-reviewer"
VALIDATOR="$SKILL_DIR/scripts/validate_pdf_architecture_reviewer.py"
...
validator_path = skill_dir / "scripts" / "validate_pdf_architecture_reviewer.py"
spec = importlib.util.spec_from_file_location("pdf_architecture_validator", validator_path)
...
printf 'pdf-architecture-reviewer check passed: valid=%s invalid=%s\n' "$valid_count" "$invalid_count"
