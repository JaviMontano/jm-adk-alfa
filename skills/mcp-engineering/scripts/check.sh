...
SKILL_DIR="$ROOT/skills/mcp-engineering"
VALIDATOR="$SKILL_DIR/scripts/validate_mcp_engineering.py"
...
validator_path = skill_dir / "scripts" / "validate_mcp_engineering.py"
spec = importlib.util.spec_from_file_location("mcp_engineering_validator", validator_path)
...
printf 'mcp-engineering check passed: valid=%s invalid=%s\n' "$valid_count" "$invalid_count"
