...
generated-for: task-subfolder
generated-on: 2026-06-05
overwrite-policy: missing-only unless --force
-->

# Task Subfolder Body of Knowledge

## Canon

Use this file for stable domain knowledge, standards, and reusable heuristics for `task-subfolder`.
