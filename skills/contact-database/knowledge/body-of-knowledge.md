...
generated-for: contact-database
generated-on: 2026-05-28
overwrite-policy: missing-only unless --force
-->

# Contact Database Body of Knowledge

## Canon

Use this file for stable domain knowledge, standards, and reusable heuristics for `contact-database`.
