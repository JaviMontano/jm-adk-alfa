...
SKILL_DIR="$ROOT/skills/katas-provenance-preservation"
VALIDATOR="$SKILL_DIR/scripts/validate_provenance_preservation.py"
...
validator_path = skill_dir / "scripts" / "validate_provenance_preservation.py"
...
printf 'katas-provenance-preservation check passed: valid=%s invalid=%s\n' "$valid_count" "$invalid_count"
