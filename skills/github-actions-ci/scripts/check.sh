...
SKILL_DIR="$ROOT/skills/github-actions-ci"
VALIDATOR="$SKILL_DIR/scripts/validate_github_actions_ci.py"
TMP_OUTPUT="$(mktemp)"
...
printf 'github-actions-ci check passed: valid=%s invalid=%s\n' "$valid_count" "$invalid_count"
