...
SKILL_DIR="$ROOT/skills/message-batch-orchestration"
VALIDATOR="$SKILL_DIR/scripts/validate_message_batch_orchestration.py"
...
validator_path = skill_dir / "scripts" / "validate_message_batch_orchestration.py"
spec = importlib.util.spec_from_file_location("message_batch_validator", validator_path)
...
printf 'message-batch-orchestration check passed: valid=%s invalid=%s\n' "$valid_count" "$invalid_count"
