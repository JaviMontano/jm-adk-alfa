...
generated-for: jarvis-bootstrap
generated-on: 2026-06-05
overwrite-policy: missing-only unless --force
-->

# Jarvis Bootstrap Body of Knowledge

## Canon

Use this file for stable domain knowledge, standards, and reusable heuristics for `jarvis-bootstrap`.
