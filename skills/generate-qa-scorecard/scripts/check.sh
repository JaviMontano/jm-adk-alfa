...
SKILL_DIR="$ROOT/skills/generate-qa-scorecard"
VALIDATOR="$SKILL_DIR/scripts/validate_qa_scorecard.py"
TMP_OUTPUT="$(mktemp)"
...
printf 'generate-qa-scorecard check passed: valid=%s invalid=%s\n' "$valid_count" "$invalid_count"
