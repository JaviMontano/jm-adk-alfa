...
SKILL_DIR="$ROOT/skills/katas-tool-description-quality"
VALIDATOR="$SKILL_DIR/scripts/validate_tool_description_quality.py"
...
validator_path = skill_dir / "scripts" / "validate_tool_description_quality.py"
spec = importlib.util.spec_from_file_location("tool_description_validator", validator_path)
...
printf 'katas-tool-description-quality check passed: valid=%s invalid=%s\n' "$valid_count" "$invalid_count"
