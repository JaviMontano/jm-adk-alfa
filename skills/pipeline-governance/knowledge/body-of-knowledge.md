...
generated-for: pipeline-governance
generated-on: 2026-05-28
overwrite-policy: missing-only unless --force
-->

# Pipeline Governance Body of Knowledge

## Canon

Use this file for stable domain knowledge, standards, and reusable heuristics for `pipeline-governance`.
