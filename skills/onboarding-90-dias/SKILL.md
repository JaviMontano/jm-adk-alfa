...
version: 0.1.0
description: "Genera un plan 30/60/90 sostenible anti-burnout para un nuevo rol."
owner: "JM Labs"
triggers:
  - onboarding-90-dias
  - plan-30-60-90
...
`scripts/plan_30_60_90.py --input <json>` emits a 30/60/90 plan and flags overload (>45h/week or >4 priorities/phase) — anti-burnout. Exit 1 on overload. Deterministic checks: `scripts/check.sh` + fixtures.
