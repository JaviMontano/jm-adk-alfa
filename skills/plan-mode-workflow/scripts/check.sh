...
SKILL_DIR="$ROOT/skills/plan-mode-workflow"
VALIDATOR="$SKILL_DIR/scripts/validate_plan_mode_workflow.py"
...
validator_path = skill_dir / "scripts" / "validate_plan_mode_workflow.py"
spec = importlib.util.spec_from_file_location("plan_mode_validator", validator_path)
...
printf 'plan-mode-workflow check passed: valid=%s invalid=%s\n' "$valid_count" "$invalid_count"
