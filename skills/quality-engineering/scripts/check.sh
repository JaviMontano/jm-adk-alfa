...
SKILL_DIR="$ROOT/skills/quality-engineering"
VALIDATOR="$SKILL_DIR/scripts/validate_quality_engineering.py"
...
validator_path = skill_dir / "scripts" / "validate_quality_engineering.py"
spec = importlib.util.spec_from_file_location("quality_validator", validator_path)
...
printf 'quality-engineering check passed: valid=%s invalid=%s\n' "$valid_count" "$invalid_count"
