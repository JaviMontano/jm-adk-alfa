...
# Notebook Curator Seleccion Body of Knowledge

## Canon

Use this file for stable domain knowledge, standards, and reusable heuristics for `notebook-curator-seleccion`.
