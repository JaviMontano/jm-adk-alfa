...
generated-for: proceso-seleccion-orchestrator
generated-on: 2026-06-05
overwrite-policy: missing-only unless --force
-->

# Proceso Seleccion Orchestrator Scripts

This directory contains deterministic local automation for `proceso-seleccion-orchestrator`.
