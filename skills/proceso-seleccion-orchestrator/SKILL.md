...
version: 0.1.0
description: "Rastrea un proceso de seleccion: extrae entrevistadores/roles/fechas de correos y mantiene tablero de estado."
owner: "JM Labs"
triggers:
  - proceso-seleccion
...
`scripts/extract_interviewers.py --input <emails.txt> [--json]` extracts interviewers/roles/dates and marks the next-to-act. Deterministic checks: `scripts/check.sh` + fixtures.
