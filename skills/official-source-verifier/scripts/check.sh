...
SKILL_DIR="$ROOT/skills/official-source-verifier"
VALIDATOR="$SKILL_DIR/scripts/validate_official_source_verifier.py"
...
validator_path = skill_dir / "scripts" / "validate_official_source_verifier.py"
spec = importlib.util.spec_from_file_location("official_source_validator", validator_path)
...
printf 'official-source-verifier check passed: valid=%s invalid=%s\n' "$valid_count" "$invalid_count"
